...
// POST crea nuovo soggetto (con livello)
router.post('/', verifyToken, async (req, res) => {
  const { tipo, nome, cognome, email, telefono, indirizzo, citta, cap, regione, referente, note, attivo, livello } = req.body;
  if (!tipo || !nome) {
...
// PUT aggiorna soggetto (con livello)
